...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, TableModule, ButtonModule, InputTextModule, TagModule, DialogModule, ConfirmDialogModule, ToastModule, ToggleSwitchModule, TooltipDirective],
    ...
    <div class="page-wrap animate-fadein-up">
      ...
      <div id="main-sticky-zone" class="sticky-header">
        <div class="page-head pt-2 pb-1 px-4">
          ...
          <button class="btn-primary" (click)="openAdd()" [appTooltip]="'Define a new scale of measurement (e.g. Box, Strip)'">
                ...
                <tr>
                  ...
                  <td>
                    <button class="status-toggle-btn"
                            ...
                            [appTooltip]="u.isActive ? 'Deactivate this Unit' : 'Activate this Unit'">
                  ...
                  <td alignFrozen="right" pFrozenColumn>
                    <div class="action-btns">
                      <button class="act-btn act-edit" [appTooltip]="'Edit Unit Details'" (click)="openEdit(u)"><i class="pi pi-pencil"></i></button>
                      <button class="act-btn act-del" [appTooltip]="'Delete Unit Profile'" (click)="confirmDelete(u)"><i class="pi pi-trash"></i></button>
                    </div>
                  </td>
                </tr>
              </ng-template>
