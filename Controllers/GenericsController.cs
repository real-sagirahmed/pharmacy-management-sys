...
namespace PharmacyApi.Controllers
{
    ...
    {
        private readonly IRepository<Models.Generic, GenericDto> _repo;

        public GenericsController(IRepository<Models.Generic, GenericDto> repo)
        {
            _repo = repo;
        }
        ...
        public async Task<ActionResult<GenericDto>> Create(GenericDto dto)
        {
            ...
            try
            {
                ...
                return CreatedAtAction(nameof(GetById), new { id = created.GenericId }, created);
            }
        ...
        public async Task<IActionResult> Update(int id, GenericDto dto)
        {
            ...
            if (id != dto.GenericId) return BadRequest("ID mismatch.");
            try
            {
